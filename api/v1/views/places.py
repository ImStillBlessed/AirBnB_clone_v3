#!/usr/bin/python3
"""
Route for handling Places objects and operations
"""
...
def get_places_by_city(city_id):
    ...
    return jsonify([place.to_dict() for place in
                    city.places]) if city else abort(404)
...
def create_place(city_id):
    ...
    if not (city and data and "user_id" in data and "name" in
            data and storage.get("User", data["user_id"])):
